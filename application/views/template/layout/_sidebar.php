...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<a href="<?= base_url() ?>" class="brand-link">
		<img src="<?= base_url() ?>assets/dist/img/<?= "AdminLTELogo.png" ?>?x=<?= time() ?>" alt="<?= "Test Unggul Solusi" ?>" class="brand-image img-circle elevation-3" style="opacity: .8">
		<span class="brand-text font-weight-light"><?= "Test Unggul Solusi" ?></span>
	</a>
